    ...
    <div class="row">
		...
		<th class="text-center">Action</th>
            ...
            if(is_allow('Action Tindaklanjut')){
				    ...
				    echo ' | '; 
				    echo anchor(site_url('pengaduan/tindaklanjut_cancel/'.$pengaduan->id_pengaduan),'Batalkan','class="text-navy" onclick="javascript: return confirm(\'Yakin ingin membatalkan tindak lanjut?\')"'); 
            }
                ?>
			</td>
		</tr>
