    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h2><b>Penyelesaian Pengaduan</b></h2>
        ...
        <div class="row" style="margin-bottom: 10px">
            ...
            <div class="col-md-3 text-right">
                <form action="<?php echo site_url('pengaduan/penyelesaian_index'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('pengaduan/penyelesaian_index'); ?>" class="btn btn-default">Reset</a>
                                    <?php
                                }
                            ?>
