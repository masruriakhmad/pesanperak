    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h2 style="margin-top:0px"><?php echo $button ?> Monitoring </h2>
                </div>
        ...
        <tr>
            <td colspan="6" class="text-center">
                <b>NOMOR PENGADUAN : <?php echo $no_pengaduan; ?> </b><br>
                <b>STATUS : <?php echo $nama_flag; ?> </b>
            </td> 
        </tr>
        <tr>
            <td colspan="2" class="text-center"><b>DATA PELAPOR</b></td>
            
            <td colspan="2" class="text-center"><b>DATA KORBAN</b></td>
            
            <td colspan="2" class="text-center"><b>DATA KEJADIAN</b></td>
        ...
        <tr>
            <td colspan="6" ><b>TANGGAL TINDAK LANJUT : <?php echo $tgl_tindak_lanjut; ?></b></td>  
        </tr>
        <tr>
            <td colspan="6" >
                <h4><b>CATATAN TINDAK LANJUT :</b></h4><?php echo $note_tindak_lanjut; ?> 
            </td> 
        </tr>
        <tr>
            <td colspan="6" ><b>TANGGAL PENYELESAIAN : <?php echo $tgl_penyelesaian; ?></b></td>  
        </tr>
        <tr>
            <td colspan="6" >
                <h4><b>CATATAN PENYELESAIAN :</b></h4><?php echo $note_penyelesaian; ?> 
            </td> 
        </tr>
    </table>
    <!--
	    ...
	    <div class="form-group">
            <label for="longtext">Catatan Penyelesaian <?php echo form_error('note_penyelesaian') ?></label>
            <textarea type="text" class="form-control" name="note_penyelesaian" id="note_penyelesaian" placeholder="Note Penyelesaian" value="<?php echo $note_penyelesaian; ?>" /></textarea>
        </div>
        -->
	    <div class="form-group">
            <label for="date">Tanggal Monitoring <?php echo form_error('tgl_monitoring') ?></label>
            <input type="date" class="form-control" name="tgl_monitoring" id="tgl_monitoring" placeholder="Tanggal Monitoring" value="<?php echo $tgl_monitoring; ?>" />
        </div>
	    <div class="form-group">
            <label for="longtext">Catatan Monitoring <?php echo form_error('note_monitoring') ?></label>
            <textarea type="text" class="form-control" name="note_monitoring" id="note_monitoring" placeholder="Catatan Monitoring" value="<?php echo $note_monitoring; ?>" /></textarea>
        </div>
        <!--
	    <div class="form-group">
