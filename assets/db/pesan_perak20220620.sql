...
CREATE TABLE `korban` (
  ...
  `foto_ybs` varchar(50) DEFAULT NULL,
...
insert  into `korban`(`id_korban`,`nik_korban`,`nama_korban`,`id_agama`,`id_desa`,`alamat_korban`,`no_hp_korban`,`foto_ktp`,`foto_ybs`,`is_active`) values 
(74,'2222222222222','bbbbbbbb',4,48,'asdasdasd','565656','1111111111111_16550870881.png','',1),
(75,'4444444444','iiyiyig',5,67,'jghgjgjh','65646456','3333333_16550872021.png','',1),
(76,'34534534','rytr',5,47,'ytryrty','4564565','454444_16550878871.png','',1),
(77,'8888888888','gddfgdfg',6,97,'ertretr','6456456','55555555555_16550880401.png','',1);
...
(39,'Tombol Input Pengaduan','Akses ke Tombol Create Pengaduan','2022-06-13 07:45:40',6,20);
...
insert  into `pelapor`(`id_pelapor`,`nik_pelapor`,`nama_pelapor`,`id_agama`,`id_desa`,`alamat_pelapor`,`no_hp_pelapor`,`foto_ktp`,`foto_ybs`,`is_active`) values 
(77,'1111111111111','aaaaaa',5,201,'dsfdsf','423423423','1111111111111_1655087088.png','',1),
(78,'3333333','uiuiui',6,303,'gjghjhgjg','45646546','3333333_1655087202.png','',1),
(79,'454444','dgdfgdf',5,187,'dfgfgdfg','45545','454444_1655087887.png','',1),
(80,'55555555555','ytrytrytr',4,201,'rtyrtytry','645645645','55555555555_1655088040.png','',1);
...
CREATE TABLE `penduduk` (
  ...
  `id_desa` int(10) NOT NULL,
  `pelapor` tinyint(1) NOT NULL DEFAULT '0',
  `korban` tinyint(1) NOT NULL DEFAULT '0',
  `pelaku` tinyint(1) NOT NULL DEFAULT '0',
  `foto_ktp` varchar(50) NOT NULL,
  `foto_ybs` varchar(50) NOT NULL,
...
(69,'P2206130001','1111111111111','2222222222222','tuyutyu',173,'gjhgjghj','2022-06-13',NULL,NULL,NULL,NULL,NULL,NULL,'2022-06-13 07:54:48',1,8),
(70,'P2206130002','3333333','4444444444','765767',173,'8678768','2022-06-13',NULL,NULL,NULL,NULL,NULL,NULL,'2022-06-13 07:56:42',1,8),
(71,'P2206130003','454444','34534534','yrytrytry',173,'765765','2022-06-13',NULL,NULL,NULL,NULL,NULL,NULL,'2022-06-13 08:08:07',1,8),
(72,'P2206130004','55555555555','8888888888','765757567',173,'utyuutuy','2022-06-13',NULL,NULL,NULL,NULL,NULL,NULL,'2022-06-13 08:10:40',1,8);
...
(8,'OPD_NAME','Peternak Kode',''),
(9,'LEFT_FOOTER','<strong>Copyright</strong> <a href=\"\">Peternak Kode</a> © 2020',''),
(10,'RIGHT_FOOTER','Peternak Kode',''),
(11,'VISI_MISI','Dilengkapi dengan tambahan helper PHP dan JS',''),
(12,'OPD_ADDR','<a href=\"\">Winkcode1-New</a>','');
